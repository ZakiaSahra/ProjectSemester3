                        ...
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    value="<?= set_value('nama_barang') ?>" id="nama_barang" placeholder="Nama Barang">
                                    <?= form_error('nama_barang', '<small class="text-danger p1-3">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="kode">Kode</label>
                                    <input type="text" name="kode" class="form-control" 
                                    value="<?= set_value('kode') ?>" id="kode" placeholder="kode">
                                    <?= form_error('kode', '<small class="text-danger p1-3">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="gambar">Foto</label>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="gambar" id="gambar" value="<?= set_value('gambar') ?>" accept=".jpg,.jpeg,.png">
                                        <label for="gambar" class="custom-file-label">Choose file</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="jumlah_pcs">Jumlah /pcs</label>
                                    <input type="text" name="jumlah_pcs" class="form-control" value="<?= set_value('jumlah_pcs') ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jumlah_bungkus" class="form-control" value="<?= set_value('jumlah_bungkus') ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="total_bungkus" class="form-control" value="<?= set_value('total_bungkus') ?>"
